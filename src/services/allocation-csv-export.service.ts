 ...
 */
export class AllocationCSVExportService {
   ...
   */
  static async exportAllocationsToCSV(
    ...
    const allocations: AllocationData[] = result.rows.map(row => {
   ...
   */
  private static generateCSVFromAllocations(
   ...
   */
  private static escapeCSVField(value: string | undefined): string {
    if (!value) return '';
   ...
   */
  static generateCSVFilename(options: CSVExportOptions = {}): string {
