 ...
 * @access Private
 */
router.get('/project/:projectId/dashboard', BudgetController.getBudgetDashboard);
 ...
 * @access Private
 */
router.get('/project/:projectId/calculate-cost', BudgetController.calculateProjectCost);
 ...
 * }
 */
router.get('/project/:projectId/track-costs', BudgetController.trackResourceCosts);
 ...
 * @access Private
 */
router.get('/project/:projectId/reports', BudgetController.generateBudgetReports);
 ...
 * @access Private
 */
router.get('/project/:projectId/variance-analysis', BudgetController.getCostVarianceAnalysis);
 ...
 * }
 */
router.post('/project/:projectId/spending', BudgetController.updateBudgetSpending);
 ...
 * }
 */
router.post('/resource-costs', BudgetController.createResourceCost);
 ...
 * }
 */
router.get('/resource-costs/employee/:employeeId', BudgetController.getResourceCostsByEmployee);
 ...
 * @access Private
 */
router.get('/resource-costs/employee/:employeeId/current', BudgetController.getCurrentEmployeeRate);
 ...
 * }
 */
router.put('/resource-costs/:id', BudgetController.updateResourceCost);
