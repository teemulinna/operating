...
router.get('/allocation', [
    (0, express_validator_1.query)('departmentId').optional().isInt({ min: 1 }).withMessage('Department ID must be a positive integer'),
...
router.post('/allocation', [
    (0, express_validator_1.body)('employeeId').isInt({ min: 1 }).withMessage('Employee ID is required and must be a positive integer'),
