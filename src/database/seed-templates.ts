...
import { ProjectTemplate, DefaultTask, DefaultMilestone, RequiredSkill, TemplateMetadata } from '../models/ProjectTemplate';
...
export class TemplateSeedService {
  ...
  constructor(private databaseService: DatabaseService) {
    // TODO: Replace with proper database query - getRepository method doesn't exist
    // this.templateRepository = this.databaseService.getRepository(ProjectTemplate);
  }
  ...
  private createSoftwareDevTemplate(): Partial<ProjectTemplate> {
    ...
    const milestones: DefaultMilestone[] = [
      {
        id: 'sw-milestone-1',
    ...
    const requiredSkills: RequiredSkill[] = [
      { skillId: 'skill-1', skillName: 'Full Stack Development', level: 'senior', quantity: 2 },
      { skillId: 'skill-2', skillName: 'UI/UX Design', level: 'mid', quantity: 1 },
      { skillId: 'skill-3', skillName: 'Business Analysis', level: 'mid', quantity: 1 },
      { skillId: 'skill-4', skillName: 'Quality Assurance', level: 'mid', quantity: 1 },
      { skillId: 'skill-5', skillName: 'DevOps', level: 'mid', quantity: 1 }
    ];
  ...
  private createMarketingCampaignTemplate(): Partial<ProjectTemplate> {
    const tasks: DefaultTask[] = [
      {
    ...
    const requiredSkills: RequiredSkill[] = [
      { skillId: 'skill-6', skillName: 'Marketing Strategy', level: 'senior', quantity: 1 },
      { skillId: 'skill-7', skillName: 'Content Creation', level: 'mid', quantity: 2 },
      { skillId: 'skill-8', skillName: 'Digital Marketing', level: 'mid', quantity: 1 },
      { skillId: 'skill-9', skillName: 'Analytics', level: 'mid', quantity: 1 }
    ];
  ...
  private createProductLaunchTemplate(): Partial<ProjectTemplate> {
    const tasks: DefaultTask[] = [
      {
    ...
    const requiredSkills: RequiredSkill[] = [
      { skillId: 'skill-10', skillName: 'Product Management', level: 'senior', quantity: 1 },
      { skillId: 'skill-11', skillName: 'Product Marketing', level: 'senior', quantity: 1 },
      { skillId: 'skill-12', skillName: 'Content Creation', level: 'mid', quantity: 2 },
      { skillId: 'skill-13', skillName: 'Sales Enablement', level: 'mid', quantity: 1 },
      { skillId: 'skill-14', skillName: 'Event Management', level: 'mid', quantity: 1 }
    ];
  ...
  private createConsultingTemplate(): Partial<ProjectTemplate> {
    const tasks: DefaultTask[] = [
      {
        id: 'cs-discovery',
    ...
    const requiredSkills: RequiredSkill[] = [
      { skillId: 'skill-15', skillName: 'Management Consulting', level: 'senior', quantity: 1 },
      { skillId: 'skill-16', skillName: 'Business Analysis', level: 'senior', quantity: 1 },
      { skillId: 'skill-17', skillName: 'Process Optimization', level: 'mid', quantity: 1 },
      { skillId: 'skill-18', skillName: 'Change Management', level: 'mid', quantity: 1 }
    ];
  ...
  private createConstructionTemplate(): Partial<ProjectTemplate> {
    const tasks: DefaultTask[] = [
      {
    ...
    const requiredSkills: RequiredSkill[] = [
      { skillId: 'skill-19', skillName: 'Construction Management', level: 'senior', quantity: 1 },
      { skillId: 'skill-20', skillName: 'Carpentry', level: 'senior', quantity: 3 },
      { skillId: 'skill-21', skillName: 'Electrical Work', level: 'senior', quantity: 2 },
      { skillId: 'skill-22', skillName: 'Plumbing', level: 'senior', quantity: 2 },
      { skillId: 'skill-23', skillName: 'HVAC', level: 'mid', quantity: 2 },
      { skillId: 'skill-24', skillName: 'General Labor', level: 'junior', quantity: 6 }
    ];
