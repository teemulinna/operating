...
exports.RoleTemplatesService = void 0;
const database_service_1 = require("../database/database.service");
class RoleTemplatesService {
    constructor() {
    ...
    async applyTemplateToProject(projectId, application) {
    ...
    async findMatchingEmployees(templateId, options) {
    ...
    `;
        ...
        for (const employee of employees.rows) {
            ...
            employee.employee_skills.forEach((skill) => {
            ...
            for (const requiredSkill of requiredSkills) {
                ...
                if (employeeLevel >= requiredLevel) {
                    ...
                    skillScore = (employeeLevel / requiredLevel) * 80;
                }
                else {
                    skillScore = 0;
                }
    ...
    async addSkillToTemplate(templateId, skillData) {
        const query = `
    ...
    async updateTemplateSkill(templateId, skillId, updates) {
        const updateFields = [];
        const params = [];
        let paramIndex = 1;
        Object.entries(updates).forEach(([key, value]) => {
    ...
    generateAssessment(matchScore, strengthsCount, gapsCount) {
        if (matchScore >= 90) {
...
exports.RoleTemplatesService = RoleTemplatesService;
//# sourceMappingURL=role-templates.service.js.map