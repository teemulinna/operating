...
class PipelineManagementService {
    ...
    async createPipelineProject(request) {
        try {
        ...
        `;
          ...
          `;
            ...
            throw new api_error_1.ApiError(500, 'Failed to create pipeline project');
        }
    }
    async getPipelineProject(id) {
      ...
      `;
            ...
            if (!result.rows.length) {
                throw new api_error_1.ApiError(404, 'Pipeline project not found');
            }
            ...
            if (error instanceof api_error_1.ApiError)
                throw error;
            throw new api_error_1.ApiError(500, 'Failed to fetch pipeline project');
        }
    }
    async getPipelineProjects(filters = {}) {
      ...
      `;
            ...
            throw new api_error_1.ApiError(500, 'Failed to fetch pipeline projects');
        }
    }
    async updatePipelineProject(request) {
        try {
            const updateFields = [];
            const queryParams = [];
            let paramIndex = 1;
      ...
      `;
            ...
            if (error instanceof api_error_1.ApiError)
                throw error;
            throw new api_error_1.ApiError(500, 'Failed to update pipeline project');
        }
    }
    async deletePipelineProject(id) {
        try {
            ...
            if (error instanceof api_error_1.ApiError)
                throw error;
            throw new api_error_1.ApiError(500, 'Failed to delete pipeline project');
        }
    }
    async getPipelineAnalytics(filters = {}) {
      ...
      `;
            ...
            throw new api_error_1.ApiError(500, 'Failed to fetch pipeline analytics');
        }
    }
    async getResourceDemandForecast() {
        const query = `
    ...
    transformPipelineProjectSummary(row) {
        return {
            id: row.id,
            crmId: row.crm_id,
            crmSource: row.crm_source,
