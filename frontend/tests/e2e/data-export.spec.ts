...
test.describe('Data Export & Sharing', () => {
  test.beforeEach(async ({ page, testHelpers }) => {
    ...
    await testHelpers.mockApiResponse('**/api/export/**', {
      success: true,
      downloadUrl: 'https://example.com/download/test-file.csv',
      fileSize: '150KB'
    });

    await testHelpers.mockApiResponse('**/api/share/**', {
      success: true,
      shareId: 'share-123',
