...
const allocation_routes_1 = require("./routes/allocation.routes");
const allocation_direct_routes_1 = require("./routes/allocation-direct.routes");
const allocation_csv_routes_1 = require("./routes/allocation-csv.routes");
const working_allocations_routes_1 = require("./routes/working-allocations.routes");
...
const skill_matching_routes_1 = require("./routes/skill-matching.routes");
const skills_matching_routes_1 = require("./routes/skills-matching.routes");
// AI and Intelligence Routes
const forecasting_routes_1 = require("./routes/forecasting.routes");
// Export and availability routes
const exportRoutes_1 = require("./routes/exportRoutes");
const availability_routes_1 = require("./routes/availability.routes");
const analytics_routes_1 = require("./routes/analytics.routes");
const reporting_routes_1 = require("./routes/reporting.routes");
const allocation_templates_routes_1 = require("./routes/allocation-templates.routes");
// import { mlOptimizationRoutes } from './routes/ml-optimization.routes'; // Temporarily disabled
const optimization_routes_1 = require("./routes/optimization.routes");
const over_allocation_warnings_routes_1 = require("./routes/over-allocation-warnings.routes");
...
const heat_map_routes_1 = require("./routes/heat-map.routes");
...
app.use('/api/capacity', heat_map_routes_1.default); // Heat map routes as sub-routes of capacity
