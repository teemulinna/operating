...
router.get('/employee/:employeeId', (0, async_handler_1.asyncHandler)(async (req, res) => {
    await db.connect();
...
router.get('/project/:projectId', (0, async_handler_1.asyncHandler)(async (req, res) => {
    await db.connect();
...
router.get('/conflicts', (0, async_handler_1.asyncHandler)(async (req, res) => {
    await db.connect();
...
router.get('/capacity', (0, async_handler_1.asyncHandler)(async (req, res) => {
    await db.connect();
    const query = `
    SELECT 
      e.id as employee_id,
...
router.post('/', (0, async_handler_1.asyncHandler)(async (req, res) => {
    await db.connect();
    const { employeeId, projectId, allocationPercentage, startDate, endDate, notes } = req.body;
    // Validation
