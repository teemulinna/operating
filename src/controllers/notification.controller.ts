...
export class NotificationController {
  ...
  public createNotification = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      if (context !== undefined) notificationData.context = context;
      ...
      if (scheduledAt) notificationData.scheduledAt = new Date(scheduledAt);
  ...
  public handleAction = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      // Now TypeScript knows userId is definitely a string
      await this.notificationService.handleNotificationAction(
        notificationId,
        userId,
        action,
        data
  ...
  public updatePreferences = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const preferences = await this.notificationService.updateNotificationPreferences(
        userId, 
        req.body
      );
  ...
  public sendTestNotification = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const notificationId = await this.notificationService.sendFromTemplate(
        'allocation_conflict',
        userId,
        {
   ...
   */
  public detectConflicts = async (req: Request, res: Response): Promise<void> => {
    try {
      const userId = req.user?.id;
   ...
   */
  public getActiveConflicts = async (req: Request, res: Response): Promise<void> => {
    try {
      const userId = req.user?.id;
